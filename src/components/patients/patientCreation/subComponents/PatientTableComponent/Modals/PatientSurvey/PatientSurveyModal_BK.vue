              ...
              <CForm class="row g-3">
                ...
                >
                  ...
                  <CFormCheck
                      ...
                      :id="`${question.tipo_pregunta}-${question.id_pregunta}-${index}`"
                      :key="option.id"
                      :label="option.opcion"
                      v-model="formData[question.id_pregunta]"
                  />
                  ...
                  <CRow v-else-if="question.id_tipo_pregunta === 4">
                    <CCol md="12">
                      <CFormCheck
                          ...
                          :id="`${question.tipo_pregunta}-${question.id_pregunta}-${index_radio}`"
                          type="radio"
                          :name="`flexRadio-${question.tipo_pregunta}-${question.id_pregunta}-${index_radio}`"
                          :key="radio.id"
                          :label="radio.opcion"
                          :value="radio.opcion"
                      />
                       ...
                       <CCol md="12" v-if="sub.id_tipo_pregunta === 1">
                         <CFormLabel :for="`sub-${sub.tipo_pregunta}-${sub.id_subpregunta}`">
                           ...
                           <CFormInput
                               ...
                               v-model="formData[sub.id_subpregunta]"
                           />
                       </CCol>
